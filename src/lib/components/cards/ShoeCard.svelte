...
>
  ...
  >
    <svg
      class="absolute top-[70px] left-5 w-[40px] h-[40px] z-20 group-hover:-translate-y-6 transition-transform"
      viewBox="0 0 48 48"
    ...
    <span
      class="translate-y-6 group-hover:translate-y-0 transition-transform text-xl mt-1 font-semibold z-10"
      >ak.soles</span
    >
    <p
